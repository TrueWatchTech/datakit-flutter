...
For details, see the [Flutter Web notes](https://docs.truewatch.com/real-user-monitoring/flutter/app-access/#flutter-web) and the [Web RUM integration guide](https://docs.truewatch.com/real-user-monitoring/web/app-access/).
